+++
title = "4D Range Queries with Sparse Summary Trees"
date = "2026"
description = "Compare sparse summary trees, scanning and spatial search on synthetic 4D queries, including construction costs and distribution dependent results."
draft = false
...
See [tree.py](tree.py); the [module README](README.md) describes usage and dependencies.
