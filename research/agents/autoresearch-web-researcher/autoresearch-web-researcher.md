+++
title = "Autoresearch: Citation Tracking for Research Agents"
date = "2026"
description = "Track exact citations through revised sources without rewriting earlier answers, and distinguish citation preservation from evidence supporting a claim."
draft = false
...
See [evidence.py](evidence.py); the [module README](README.md) describes usage and dependencies.
