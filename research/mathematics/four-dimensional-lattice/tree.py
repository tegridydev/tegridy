"""Exact sparse 16-way summary tree, retaining observations for partial leaves."""
...
class Tree:
    def __init__(
        self, points, bounds=((0.0, 1.0),) * 4, capacity=16, max_depth=12, _depth=0
    ):
        ...
        for code, group in groups.items():
            ...
            self.children[code] = Tree(
                group, child_bounds, capacity, max_depth, _depth + 1
            )
        self.points = []
