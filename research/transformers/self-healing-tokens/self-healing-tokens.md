+++
title = "Self Healing Tokens: Selective Denoising Experiments"
date = "2026"
description = "Compare learned token repair with majority repair, including recovery of corrupt tokens and harm to clean inputs in a controlled synthetic task."
draft = false
...
For a larger follow up, split 30,000 distinct clean records before generating corruption. This is a proposed data budget, not the size of the recorded comparison. All variants of one clean record stay in its split. Training resamples corruption; final evaluation freezes variants at several rates plus a harder 0.30 condition and a separate checksum corruption stress test.
