+++
title = "SL5: Thread Aware Retrieval and Quote Attribution"
date = "2026"
description = "Preserve nested quote attribution, source timestamps and thread context, while separating exact attribution tests from forecast scoring and retrieval quality."
draft = false
...
The original target was five questions over ten messages. The larger saved attribution fixture now covers 100 threads, but exact quote attribution still does not measure retrieval usefulness. That needs a separate question set before spatial navigation or historical personas would add value.
...
See [thread.py](thread.py); the [module README](README.md) describes usage and dependencies.
