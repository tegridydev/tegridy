+++
title = "Protocol Resource Limits and Amplification Modelling"
date = "2026"
description = "Inspect byte, work, connection and time budgets in local protocol simulations, without treating bounded fixtures as evidence of live vulnerabilities."
draft = false
...
See [budgets.py](budgets.py); the [module README](README.md) describes usage and dependencies.
