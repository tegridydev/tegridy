+++
title = "SVD Compression: Storage and Functional Error"
date = "2026"
description = "Compare SVD factor storage with held out output error on a GPT Neo projection, and see why weight similarity alone cannot establish useful compression."
draft = false
...
See [compress.py](compress.py); the [module README](README.md) describes usage and dependencies.
