+++
title = "Processing Saved Chat Logs Without Losing History"
date = "2026"
description = "Process saved chat JSON into traceable fields while preserving message IDs, edits, timestamps and source pages. This is an offline export workflow."
draft = false
...
See [export_logs.py](export_logs.py); the [module README](README.md) documents the JSON page format. Output preserves raw message objects and the source file hash.
