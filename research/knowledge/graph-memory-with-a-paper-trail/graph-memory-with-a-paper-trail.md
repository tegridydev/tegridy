+++
title = "Graph Based Research Memory with Source Provenance"
date = "2026"
description = "Compare graph and metadata retrieval on versioned sources, keeping source history visible and accounting for cases where the simpler baseline matches it."
draft = false
...
| --- | ---: |
| graph · support recall (%) | 100 |
| lexical · support recall (%) | 0 |
| metadata only · support recall (%) | 100 |
...
See [cedar.py](cedar.py); the [module README](README.md) describes usage and dependencies.
