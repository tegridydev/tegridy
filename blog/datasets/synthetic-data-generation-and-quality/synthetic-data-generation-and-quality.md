+++
title = "Synthetic Datasets with Independent Validation"
date = "2026"
description = "Generate synthetic examples from checkable source facts, validate answers independently and split parent records before producing related variants."
draft = false
...
See [generate.py](generate.py) or the [module README](README.md).
