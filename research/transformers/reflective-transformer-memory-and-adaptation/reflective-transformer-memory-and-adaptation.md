+++
title = "Transformer Memory: Causal Retrieval and Adaptation"
date = "2026"
description = "Test delayed memory retrieval, episode reset and batch isolation, with explicit limits on comparisons between memory systems of different capacities."
draft = false
...
| --- | ---: | ---: |
| attention · accuracy (%) | 97.188 | 1.263 |
| attention · evicted · accuracy (%) | 96.749 | 1.308 |
| attention · retained · accuracy (%) | 97.729 | 1.25 |
| fifo · accuracy (%) | 35.977 | 3.269 |
| fifo · evicted · accuracy (%) | 4.028 | 0.536 |
| fifo · retained · accuracy (%) | 75.459 | 7.753 |
| none · accuracy (%) | 7.422 | 0 |
| none · evicted · accuracy (%) | 7.42 | 0 |
| none · retained · accuracy (%) | 7.424 | 0 |
...
See [memory.py](memory.py); the [module README](README.md) describes usage and dependencies.
