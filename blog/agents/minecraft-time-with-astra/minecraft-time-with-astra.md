+++
title = "Building a Minecraft Style Browser Game with Astra"
date = "2026"
updated = "2026-09-09"
description = "A personal browser game experiment with one playable original, successive screenshots and notes on the Astra and Codex revisions."
draft = false
...
topic = "agent-systems"
related = []
image = "/blog/agents/minecraft-time-with-astra/wild-block-one-shot-1200.webp"
image_alt = "Screenshot of the first Wild Block browser game prototype."
+++

# Building a Minecraft Style Browser Game with Astra
...
The model and effort names below are the labels I used in those sessions. This is a personal build log, not a controlled comparison of model versions.
...
Getting to a similar level of quality and feature depth with **Sol 5.6** had taken me around **3 to 5 hours**, including multiple Codex revision runs using xHigh for planning and Medium for coding.
